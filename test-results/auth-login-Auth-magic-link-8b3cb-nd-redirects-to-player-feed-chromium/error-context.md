...
- Name: auth-login.spec.ts >> Auth: magic link login >> valid player code auto-authenticates and redirects to player feed
- Location: e2e/auth-login.spec.ts:22:7
...
waiting for navigation to "**/" until "load"
  navigated to "http://localhost:3000/login/valid-player-code"
============================================================
```
