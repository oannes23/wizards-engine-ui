...
- Name: session-flow.spec.ts >> Session flow: GM starts a session >> navigates to a draft session detail, clicks Start Session, session becomes active
- Location: e2e/session-flow.spec.ts:99:7
