...
- Name: auth-login.spec.ts >> Auth: magic link login >> invite code redirects to /join with code in query string
- Location: e2e/auth-login.spec.ts:51:7
...
=========================== logs ===========================
waiting for navigation to "**/join" until "load"
  navigated to "http://localhost:3000/login/valid-invite-code"
============================================================
```
